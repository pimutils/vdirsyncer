# -*- coding: utf-8 -*-
#
# vdirsyncer documentation build configuration file, created by
...
try:
    release = pkg_resources.require('vdirsyncer')[0].version  # The full version, including alpha/beta/rc tags.
